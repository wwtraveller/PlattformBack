...
public class UserController {
    ...
    @Operation(summary = "Create a new user") // Опис операції
    @ApiResponses(value = {
    ...
    @Operation(summary = "Get all users") // Опис операції
    @ApiResponses(value = {
    ...
    @Operation(summary = "Get user by ID") // Опис операції
    @ApiResponses(value = {
    ...
    @Operation(summary = "Update user by ID") // Опис операції
    @ApiResponses(value = {
    ...
    @Operation(summary = "Delete user by ID") // Опис операції
    @ApiResponses(value = {
